...
export const RELICS={
  ...
  nasikh:{n:'الناسخ',d:'بعد كل ختم، تُنسخ أغلى حروف الكلمة إلى كيسك (يتسع الكيس حتى ١٣).'},
  eater:{n:'آكل الحروف',d:'ختم كلمة من ٥ أحرف فأكثر يلتهم أحد حروفها من كيسك نهائيًا، ويمنحك +١ مضاعف دائم.'},
  mill:{n:'حجر الرحى',d:'كل سطر ينكسر يمنحك +٠٫٥ مضاعف دائم طوال الرحلة.'},
  ring:{n:'الخاتم',d:'حروف الكلمة المختومة تعود إلى أعلى كومة السحب، فتسقط عليك من جديد.'},
  ...
  wazzan:{n:'الوزّان',d:'مكافأة الوزن تُحسب مرتين.'},
  inkwell:{n:'المحبرة',d:'خانة رابعة في الدفتر، وجذور الدفتر تكسب الخبرة مضاعفة.'},
  orphan:{n:'اليتيم',d:'إذا كان في كيسك ٧ حروف أو أقل: كل كلمة ×٣.'},
  pen:{n:'القلم المكسور',d:'السطور لا تنكسر. السطر الميت يصير حشوًا تمسحه مقابل ٣ نقاط لكل حرف.'},
  thread:{n:'خيط الحبر',d:'ختم كلمة يختم تلقائيًا كل سطر آخر فيه كلمة مكتملة.'},
...
export const ROWMODS={
  ...
  gold:{n:'ذهب',d:'+٢ دينار عن كل ختم في هذا السطر.'},
  short:{n:'قِصار',d:'الكلمات من حرفين أو ثلاثة هنا ×٣.'},
  long:{n:'طِوال',d:'الكلمات من ٥ أحرف فأكثر هنا ×٣.'},
  echo:{n:'صدى',d:'بعد الختم يحتفظ السطر بآخر حرف من الكلمة ليبدأ به.'},
  fort:{n:'حِصن',d:'السطر لا ينكسر: الحرف الذي يقتله يرتد ويضيع وحده.'},
};
export const BOSSES={
