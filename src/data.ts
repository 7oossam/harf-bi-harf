...
export const RELICS={
  ...
  naht:{n:'النَّحت',hook:'affix',rare:1,
    d:'زوائدك لا تُستهلَك أبدًا، لكن كل ختم يكلّفك ديناريْن.'},
...
/* ================= المُؤتلِفات — COMBOS ================= */
export const COMBOS=[
  {n:'المِصْنَع', parts:['relic:tasrif','relic:miraj'],
   d:'الجذر يبقى في سطره بعد الختم، وكل ختم عليه يضاعف ما قبله: سطرٌ واحد يصير مصنعًا.'},
  ...
  {n:'الجذر الراسخ', parts:['relic:ishtiqaq','mark:free'],
   d:'البطاقة الطليقة لا تُستهلَك فتعود إليك، فتكرّر الجذر نفسه والاشتقاق يضاعفه.'},
